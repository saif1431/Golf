...
function OurService() {
  return (
    <div className='max-w-7xl h-fit mx-auto py-16 px-4'>
      <section className='flex items-center gap-8 flex-col justify-center mt-12'>
            <h2 className='lg:text-5xl text-3xl text-center leading-tight font-bold text-gray-800'>Where Comprehensive Training Meets Science-Backed Performance</h2>
...
<button className='btn-primary text-white py-2 px-6 rounded-md'>Defy Your Limits NOW</button>
      </section>
    </div>
  )
}
